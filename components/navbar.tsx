...
const defaultNavigationLinks: NavbarNavLink[] = [
  { href: "/", label: "Cayo Perico Loot Calculator", labelKey: "calculator.title" },
  { href: "/casino-calculator", label: "Diamond Casino Calculator", labelKey: "calculator.diamond-casino" },
]
  ...
  (
    {
      ...
      logo = <Logo />,
      logoHref = "#",
      navigationLinks: navLinksFromProps,
      signInText = "Sign In",
      signInHref = "#signin",
      ctaText = "Get Started",
      ctaHref = "#get-started",
    ...
    const navigationLinks = (navLinksFromProps || defaultNavigationLinks).map((link) => ({
      ...link,
      active:
        link.href === "/"
          ? pathname === "/"
          ...
          <div className="flex items-center gap-2">
                        ...
                        <NavigationMenuItem className="w-full" key={index}>
                          <NavigationMenuLink asChild>
                            <Link
                              ...
                              href={link.href}
                            >
                              {link.labelKey ? resolveLabel(link.labelKey, link.label) : link.label}
                            </Link>
                          </NavigationMenuLink>
                        </NavigationMenuItem>
                      ))}
            ...
            <div className="flex items-center gap-6">
              <Link
                ...
                href={logoHref}
              >
                <span className="hidden font-bold text-xl sm:inline-block">GTA-Tools</span>
              </Link>
              {/* Navigation menu */}
              {!isMobile && (
